...
# Define the SGC model with two layers
class SGC(torch.nn.Module):
    def __init__(self, num_features, hidden_dim1, hidden_dim2, num_classes):
        super(SGC, self).__init__()
        self.conv1 = SGConv(num_features, hidden_dim1, K=2, cached=True)
        self.conv2 = SGConv(hidden_dim1, hidden_dim2, K=1, cached=True)
